package com.example.root.simpleformvalidation;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        awesomeValidation.addValidation(this, R.id.editTextMobile, "^([0-9\\+]|\\(\\d{1,3}\\))[0-9\\-\\. ]{3,15}$", R.string.mobileerror);
        ...
        awesomeValidation.addValidation(this, R.id.editTextAge, Range.closed(0,100), R.string.ageerror);
